  ...
  return (
    <div className=''>
      ...
      <Section size="full" spacing="none" styling="h-screen p-12 hidden xl:flex">
        <Split className='h-full w-full flex border-4'
      ...
      <Section size="full" spacing="none" styling="h-screen p-12 xl:hidden">
        <div className='h-full w-full flex border-4'>
          <div className="relative p-12 text-h1 overflow-hidden">
          Es ist nie zu spät → Versuch mal was neues
      ...
      <Section size="medium" styling="text-center dark:text-white">
